...
import htmlTemplatesFormularioDuvidas from "./templates/template-formulario-duvidas.mjs";
...
export default async function enviarEmailFormularioDuvidas(dadosUsuario, dadosEmail) {
  const transporter = nodemailer.createTransport({
    ...
    const enviarEmail = await transporter.sendMail({
      ...
      html: htmlTemplatesFormularioDuvidas(dadosUsuario,dadosEmail), // html/template
      attachDataUrls: true,
    });
