...
import htmlTemplatesErroCartao from "./templates/template-error-cartao.mjs";
...
export default async function enviarEmailErroCartao(dadosUsuario, dadosEmail) {
  const transporter = nodemailer.createTransport({
    ...
    const enviarEmail = await transporter.sendMail({
      ...
      html: htmlTemplatesErroCartao(dadosUsuario,dadosEmail), // html/template
      attachDataUrls: true,
    });
